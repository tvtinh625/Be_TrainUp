...
public class SizeVariantReq {
    ...
    private List<@Size(max = 500, message = "URL ảnh không được vượt quá 500 ký tự") String> imageUrls;
    ...
    @Valid
    @Size(max = 5, message = "Tối đa 5 hương vị cho mỗi size")
    private List<FlavorVariantReq> flavors;
}