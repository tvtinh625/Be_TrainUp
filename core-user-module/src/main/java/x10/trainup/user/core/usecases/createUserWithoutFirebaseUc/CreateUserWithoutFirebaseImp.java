...
@Service
@AllArgsConstructor
public class CreateUserWithoutFirebaseImp implements ICreateUserWithoutFirebase{

    private final IUserRepository userRepository;
    private final PasswordEncoder passwordEncoder;
    @Override
    public UserEntity process(CreateUserFireBaseReq input) {
        ...
        UserEntity user = UserEntity.builder()
                ...
                .status(UserStatus.ACTIVE) // mặc định PENDING khi đăng ký
                .emailVerified(true)
